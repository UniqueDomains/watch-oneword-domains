# Available .WATCH One-Word Domains (5,622,098)
...
> **Important:** this repository is a **public 8,683-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,098 domains** on the canonical page below.

**Public extract:** 8,683 rows · **Live catalog:** 5,622,098 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/watch?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_watch_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/watch?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_watch_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./watch.csv">CSV</a> / <a href="./watch.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_watch_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_watch_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .WATCH search](https://unique.domains/domains/tld/watch?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_watch_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .WATCH search](https://unique.domains/domains/tld/watch?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_watch_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./watch.csv) or [Download JSON](./watch.json)
...
- `watch.csv` — public CSV extract (8,683 rows)
- `watch.json` — public JSON extract (8,683 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,683-row public sample | 5,622,098 live domains                           |
...
| --------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------------------------------------------------------- |
| wizard.watch    | available | $4.99     | $56.99        | 118            | 46     | 6      | name.com                                                  |
| now.watch       | resell    | —         | —             | 78             | 66     | 3      | Sav.com, LLC                                              |
| athletics.watch | premium   | $85.80    | $85.80        | 69             | 52     | 9      | namecheap                                                 |
| agile.watch     | available | $4.99     | $56.99        | 92             | 42     | 5      | name.com                                                  |
...
| unity.watch     | available | $4.99     | $56.99        | 70             | 41     | 5      | name.com                                                  |
| home.watch      | resell    | —         | —             | 100            | 62     | 4      | GoDaddy.com, LLC                                          |
| energy.watch    | premium   | $520      | $520          | 82             | 46     | 6      | namecheap                                                 |
| craft.watch     | available | $4.99     | $56.99        | 70             | 41     | 5      | name.com                                                  |
| space.watch     | resell    | —         | —             | 76             | 61     | 5      | GoDaddy.com, LLC                                          |
| hotel.watch     | premium   | $520      | $520          | 70             | 46     | 5      | namecheap                                                 |
...
| europe.watch    | available | $4.99     | —             | 68             | 39     | 6      | name.com                                                  |
| data.watch      | resell    | —         | —             | 70             | 60     | 4      | GoDaddy.com, LLC                                          |
...
> Unique Domains. *Available .WATCH One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
